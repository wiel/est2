...
function checkUser()
{
	...
	switch (role){
		...
		case "patient":
			// alert ("mic_on: "+mic_on);
			if (mic_on == 1){
				$(".menu_item_text3").text("Oefeningen");
			}else{
			...
			switch (Number(menu_item)){
				...
				case 1:
					if (mic_on == 1){
						$('#content').load('/content/patient/vu2.php');
					}else{
				...
				case 3:
					if (mic_on == 1){
						$('#content').load('/content/patient/oefeningen.php');
					}else{
						micOn();
				...
				case 4:
					if (mic_on == 1){
						$('#content').load('/content/patient/vu3.php');
					}else{
						$('#content').load('/content/patient/nop.php');
					}
					break;
...
function micOn ()
{
	...
	// $('#webaudio').load('/content/patient/webaudio.php');
	$('#content').load('/content/patient/vu.php');
	$(".menu_item_text3").text("Oefeningen");
